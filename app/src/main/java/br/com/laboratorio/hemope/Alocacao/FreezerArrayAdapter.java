...
public class FreezerArrayAdapter extends ArrayAdapter<Freezer> {

private ArrayList<Freezer> objects;
private Context context;


    public FreezerArrayAdapter(Context context, int resource, ArrayList<Freezer> objects) {
    ...
    public View getCustomView(int position, View convertView, ViewGroup parent) {
        ...
        label.setText(objects.get(position).codigo);
